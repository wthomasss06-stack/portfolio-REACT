...
function StackedRealisations() {
  ...
  return (
    <section style={{ background: T.bg, position: 'relative' }}>
      {/* grid-bg ne peut pas être en position:absolute si la section n'a pas overflow:hidden  */}
      {/* on l'encapsule dans un div non-overflow pour ne pas casser sticky */}
      ...
      <div
        ...
        style={{
          ...
          gap: '3rem',
          alignItems: 'start',
          overflow: 'visible',   // ← NE PAS mettre hidden ici, ça casse sticky
        }}
        className="projects-sticky-grid"
      >

        {/* ── COLONNE GAUCHE : STICKY ── */}
        <div style={{ position: 'sticky', top: '12vh', alignSelf: 'start', height: 'fit-content' }}>
          <div style={{
            padding: '2.5rem',
            borderRadius: 24,
