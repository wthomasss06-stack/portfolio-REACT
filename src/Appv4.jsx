...
import { PROJECTS, PRICING_TABS, TIMELINE } from './data/portfolioData.js'
...
function SkewSection() {
  const items = [
    { img: '/assets/images/projects/CB.webp', title: '01 — Code propre & sécurisé', body: "Chaque ligne de code applique les bonnes pratiques : auth, permissions, validation côté serveur. La sécurité n'est pas une option, c'est une fondation." },
    { img: '/assets/images/projects/jean-edy-preview.webp', title: '02 — Interface pensée usages réels', body: "Des interfaces React/Next.js pensées pour l'utilisateur final. Responsive, rapides, accessibles — pas juste belles." },
    { img: '/assets/images/projects/C.webp', title: '03 — Livraison dans les délais', body: "Communication transparente à chaque étape. Vous suivez l'avancement en temps réel, aucune surprise à la livraison." },
    { img: '/assets/images/projects/A.webp', title: '04 — Data & Carto intégrés', body: 'Dashboards interactifs, visualisations Chart.js, cartes Leaflet/OpenStreetMap ou MAPBOX Je transforme vos données en décisions.' },
  ]
